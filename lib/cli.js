...
const optionDefinitions = [
  ...
  { 
    ...
    alias: 'u',
    type: Boolean,
    description: 'Upgrade packages to their newest versions',
  },
  { 
    name: 'help',
    alias: 'h',
...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        desc: '4. Copy all dependencies from the project in your current folder and upgrade to the newest versions.',
        example: '$ cp-dep -cu',
      },
    ],
  },
